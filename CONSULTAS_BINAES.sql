...
SELECT U.NOMBRE, U.email AS 'CORREO ELECTRONICO', U.DIRECCION, U.OCUPACION, U.INSTITUCION, T.TELEFONO, U.FOTO, U.cod_qr AS ' CODIGO QR', U.password_user AS 'CONTRASEÑA'
FROM USUARIO U
