...
--MOSTRANDO EJEMPLARES DE LA COLECCION JUVENTUD
SELECT E.NOMBRE AS 'EJEMPLAR', C.NOMBRE AS 'COLECCION', TC.nombre AS 'TIPO COLECCION', G.nombre AS 'GENERO'
FROM EJEMPLAR E
...
--mostrando ejemplares audiovisuales
SELECT E.NOMBRE AS 'EJEMPLAR', C.NOMBRE AS 'COLECCION', TC.nombre AS 'TIPO COLECCION', G.nombre AS 'GENERO'
FROM EJEMPLAR E
INNER JOIN COLECCION C
ON E.id_coleccion = C.id
